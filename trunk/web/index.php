...
//echo $sql;
  ...
  $sql="select avg(sp) sp from (select  count(1) sp,judgetime from solution where result>3 and judgetime>convert(now()-60,DATE)  group by judgetime order by sp) tt;";
